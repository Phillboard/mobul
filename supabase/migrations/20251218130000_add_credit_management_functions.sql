...
-- =====================================================
-- Adds essential RPC functions for credit operations:
-- - get_credit_account: Get or create credit account
-- - allocate_credits_atomic: Add credits to an account
-- - deduct_credits_atomic: Deduct credits with validation
-- - transfer_credits_atomic: Transfer between accounts
-- - get_credit_balance: Get current balance
-- - get_credit_transaction_history: Get transaction history
-- =====================================================
...
-- ============================================================
-- 2. Get credit balance (simple read)
-- ============================================================
...
-- ============================================================
-- 3. Allocate credits (add to account)
-- ============================================================
...
-- ============================================================
-- 4. Deduct credits with validation
-- ============================================================
...
-- ============================================================
-- 6. Get credit transaction history
-- ============================================================
...
COMMENT ON FUNCTION get_credit_account IS 'Get or create a credit account for an entity';
COMMENT ON FUNCTION get_credit_balance IS 'Get current credit balance for an entity';
COMMENT ON FUNCTION allocate_credits_atomic IS 'Add credits to an account (creates account if needed)';
COMMENT ON FUNCTION deduct_credits_atomic IS 'Deduct credits from an account with validation';
COMMENT ON FUNCTION transfer_credits_atomic IS 'Transfer credits between two accounts';
COMMENT ON FUNCTION get_credit_transaction_history IS 'Get transaction history for an entity';
