-- Fix claim_card_atomic to charge client credits when a gift card is claimed
-- This ensures clients are properly billed for gift cards assigned to recipients
