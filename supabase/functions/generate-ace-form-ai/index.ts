    ...
    const response = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `You are an expert form designer. Generate a complete form configuration based on the user's description. 
            
CRITICAL RULES:
1. ALWAYS include a "gift-card-code" field type for redemption
2. Include relevant fields for the use case (name, email, phone, etc.)
3. Set appropriate validation rules
4. Make the form user-friendly with good placeholders and help text
