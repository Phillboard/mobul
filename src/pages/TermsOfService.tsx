      ...
      <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>Direct mail campaign creation and management</li>
            <li>Template design and customization</li>
            <li>Audience management and targeting</li>
            <li>Gift card reward management</li>
            <li>Landing page creation</li>
            <li>Analytics and reporting</li>
            <li>Call center management tools</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <h3 className="text-xl font-semibold mb-2 mt-4">Account Creation</h3>
          <p>
            To use our Service, you must create an account. You agree to provide accurate, current, and
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">Billing and Payment</h2>
          
          <h3 className="text-xl font-semibold mb-2 mt-4">Subscription Plans</h3>
          <p>
            We offer various subscription plans with different features and pricing. You will be billed
            according to your selected plan on a recurring basis.
          </p>

          <h3 className="text-xl font-semibold mb-2 mt-4">Payment Terms</h3>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h3 className="text-xl font-semibold mb-2 mt-4">Price Changes</h3>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            us a license to use, store, and process it solely for providing the Service.
          </p>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">Warranties Disclaimer</h2>
          <p>
        ...
        <section>
          ...
          <p>
            These Terms shall be governed by the laws of [Your State/Country], without regard to its
