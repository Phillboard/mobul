/**
 * Enhanced Credit Management Hooks - Updated for API-First Architecture
 * 
 * Now uses edge functions instead of direct RPC calls for business logic
 */
 ...
 * NEW: Server-side calculation with validation
 */
 ...
 * NOTE: This is kept as RPC because it's a simple atomic operation
 * For complex allocation logic, consider creating an edge function
 */
 ...
 * NEW: Enhanced with server-side calculation option
 */
